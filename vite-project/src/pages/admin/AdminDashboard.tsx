...
export default function AdminDashboard() {
  ...
  // Helper untuk memformat angka ke format Rupiah Indonesia
  const formatCurrency = (amount: number) => {
    return new Intl.NumberFormat("id-ID").format(amount);
  };

  // Helper untuk menghitung total harga jika tidak terdefinisi
  const calculateOrderTotal = (order: any) => {
    ...
    return itemsTotal + (order.deliveryFee || 0) + (order.tax || 0);
  };
